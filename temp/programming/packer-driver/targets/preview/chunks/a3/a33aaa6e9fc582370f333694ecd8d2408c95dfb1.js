    ...
    execute: function () {
      ...
      _export("WxApi", WxApi = (_dec = ccclass('WxApi'), _dec(_class = class WxApi extends Component {
        ...
        onLoad() {
          ...
          this.loadVideoAd("adunit-c21c3786607b856f"); //加载插屏广告

          this.loadInterstitialAd("adunit-127f752a1e417efd"); // 监听游戏显示事件
        ...
        sendCodeToServer(code) {
          wx.request({
            url: 'https://yx.megoo.top/wochengyuteniu/user/getWxOpenId',
...
//# sourceMappingURL=a33aaa6e9fc582370f333694ecd8d2408c95dfb1.js.map