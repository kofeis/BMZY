System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, AudioClip, director, AudioSource, sys, CCBoolean, v3, SpriteFrame, view, game, Game, assetManager, Texture2D, isValid, Material, JsonAsset, Font, AnimationClip, UITransform, Tool_Event, Tool_Other, Tool_UI, PlatformApi, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _class3, _crd, ccclass, property, Scene_Change_Type, Resoure_Data;
      ...
      _export("Resoure_Data", Resoure_Data = (_dec = ccclass('Resoure_Data'), _dec2 = property({
        ...
        constructor() {
          ...
          this.FrameRate_Schedule = () => {
            ...
            var currentFrameRate = this.FrameRate / Time_Elapsed;
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield _this.Load_SpriteFrame("SpriteFrame/Panel/PanelMathMatch/BoxC");
            yield _this.Load_SpriteFrame("SpriteFrame/Panel/PanelMathMatch/BoxN");
            yield _this.Load_SpriteFrame("SpriteFrame/Panel/PanelMathMatch/BoxE");
            yield _this.Load_SpriteFrame("SpriteFrame/Panel/PanelMathMatch/BoxU");
            yield _this.Load_Json("Json/mathmatch");
            yield _this.Load_Prefab("Prefab/PanelMathMatch/Icon");
          })();
        }
        /**是否首次启动 */
        ...
        Fetch_Data(Url) {
          ...
          return _asyncToGenerator(function* () {
            if ((_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
              ...
              return _this2.Fetch_DataWX(Url);
            } else {
              try {
        ...
        Update_Data(Url, Data) {
          ...
          return _asyncToGenerator(function* () {
            if ((_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
              ...
              return _this3.Update_DataWX(Url, Data);
            } else {
              try {
                var Response = yield fetch(Url, {
                  method: 'PUT',
...
//# sourceMappingURL=115be2cd6f1bedf01aee209d94ad2252a7ca66ce.js.map