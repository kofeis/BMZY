    ...
    execute: function () {
      ...
      _export("cocosUtil", cocosUtil = {
        ...
        addComponentOnce(item, name) {
          var comp = item.getComponent(name);
        ...
        isInScreenVisible(node) {
          ...
          var pos = cocosUtil.convertToWorldSpace(node.parent, node.getPosition());
        ...
        nodeChangeParent(node, parent) {
          ...
          var pos = cocosUtil.convertToWorldSpace(parent, node.getPosition());
          node.parent = parent;
