    ...
    execute: function () {
      ...
      _export("Bg", Bg = (_dec = ccclass('Bg'), _dec(_class = class Bg extends Component {
        ...
        Screen_Update_Horizontal() {
          var H_Canvas = find("Canvas").getComponent(UITransform).height;
          var H = 1138; //this.node.getComponent(UITransform).height
...
//# sourceMappingURL=b766988b67ca09db9188ec47a0ed48337efcd263.js.map