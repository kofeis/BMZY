      ...
      _export("PanelFindWolf", PanelFindWolf = (_dec = ccclass('PanelFindWolf'), _dec(_class = class PanelFindWolf extends (_crd && PanelTemplate === void 0 ? (_reportPossibleCrUseOfPanelTemplate({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.LevelBg = find("Window/LevelBg", _this.node);
            _this.Wolfs = find("Window/Wolfs", _this.node);
            _this.BtnTip = find("Panel/PanelBtn/BtnTip", _this.node);
            _this.BtnSetting = find("Panel/PanelBtn/BtnSetting", _this.node);
            _this.PanelVictory = find("Panel/PanelVictory", _this.node);
            _this.PanelVictory.active = false;
            _this.BtnNext = find("BtnNext", _this.PanelVictory);
            _this.Max_X = _this.Wolfs.getComponent(UITransform).width / 2;
            _this.Min_X = -_this.Max_X;
            _this.Max_Y = _this.Wolfs.getComponent(UITransform).height / 2;
            _this.Min_Y = -_this.Max_Y;
        ...
        GameStart() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this2.PanelVictory.active = false;
            ...
            var PosArr = (_crd && Tool_Other === void 0 ? (_reportPossibleCrUseOfTool_Other({
              error: Error()
            }), Tool_Other) : Tool_Other).instance.Get_Random_Pos_Arr(10, _this2.Min_X, _this2.Max_X, _this2.Min_Y, _this2.Max_Y);

            if (_this2.Wolfs.children.length == 0) {
              var PrefabWolf = yield _this2.Resoure_Data.Load_Prefab("Prefab/PanelFindWolf/Wolf");

              var _loop = function* _loop() {
                var Wolf = (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                  error: Error()
                }), Tool_UI) : Tool_UI).instance.Set_Prefab_Node(PrefabWolf, _this2.Wolfs, v3(0, 0, 0), "");
                Wolf.position = PosArr[i];
                Wolf.getChildByName("Sp").scale = v3(_this2.ScaleArr[i], _this2.ScaleArr[i], 1);
                ...
                (_crd && Tool_Event === void 0 ? (_reportPossibleCrUseOfTool_Event({
                  ...
                  _this2.ShowSelect(Wolf);

                  _this2.Score++;

                  if (_this2.Score == _this2.ScoreTarget) {
                    _this2.GameVictory();
                  }
                });
              ...
              for (var _i = 0; _i < _this2.Wolfs.children.length; _i++) {
                _this2.Wolfs.children[_i].position = PosArr[_i];
                _this2.Wolfs.children[_i].getChildByName("Sp").scale = v3(_this2.ScaleArr[_i], _this2.ScaleArr[_i], 1);

                _this2.Wolfs.children[_i].getChildByName("Sp").getComponent(Animation).play();

                _this2.Wolfs.children[_i].getChildByName("Tip").active = false;
                _this2.Wolfs.children[_i].getChildByName("Select").active = false;
              }
            }
          })();
        }
        ...
        DataGet() {
          /**openId */
          var FindWolfLevel = this.Resoure_Data.Data_Get("FindWolfLevel");
