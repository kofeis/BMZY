  ...
  return {
    ...
    execute: function () {
      ...
      _export("SettingLayer", SettingLayer = (_dec = ccclass('SettingLayer'), _dec(_class = class SettingLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        initUI() {
          var musicVol = (_crd && audioManager === void 0 ? (_reportPossibleCrUseOfaudioManager({
            error: Error()
          ...
          var effectVol = (_crd && audioManager === void 0 ? (_reportPossibleCrUseOfaudioManager({
            error: Error()
