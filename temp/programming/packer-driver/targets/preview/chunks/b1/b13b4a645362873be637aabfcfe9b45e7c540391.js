    ...
    execute: function () {
      ...
      _export("Adaptation", Adaptation = (_dec = ccclass('Adaptation'), _dec(_class = class Adaptation extends Component {
        ...
        Screen_Update_Horizontal() {
          /**游戏画布高度 */
          var Height_Canvas = (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
            error: Error()
          }), Tool_UI) : Tool_UI).instance.Get_Height_Visible();
          /**游戏设计高度 */

          var Height_Design = (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
            error: Error()
          }), Tool_UI) : Tool_UI).instance.Get_Height_Design();
          var Size = Height_Canvas / Height_Design;
        ...
        Screen_Update_Vertical() {
          /**游戏画布高度 */
          var Width_Canvas = (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
            error: Error()
          }), Tool_UI) : Tool_UI).instance.Get_Width_Visible();
          /**游戏设计高度 */

          var Width_Design = (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
            error: Error()
          }), Tool_UI) : Tool_UI).instance.Get_Width_Design();
          var Size = Width_Canvas / Width_Design;
          this.node.scale = v3(Size, Size, 1);
...
//# sourceMappingURL=b13b4a645362873be637aabfcfe9b45e7c540391.js.map