      ...
      _export("WxApi", WxApi = (_dec = ccclass('WxApi'), _dec(_class = class WxApi extends Component {
          ...
          wx.login({
            ...
            success: res => {
              if (res.code) {
                ...
                var openId = this.Data_Get("openId");

                if (openId == null || openId == undefined) {
                  this.sendCodeToServer(res.code);
                } else {
                  // let ge = new GravityPlatform();
                  // ge.initGeSdk(this.openId);
                  // window.ge = ge;
        ...
        sendCodeToServer(code) {
          wx.request({
            ...
            //https://yx.megoo.top/zdydc/user/login  https://yx.megoo.top/wochengyuteniu/user/getWxOpenId   "o1y5c7B6-v6rHdcphhiYjkSS-k2Y"
            method: 'POST',
            data: {
              code: code
            },
            success: res => {
              ...
              (_crd && GravityPlatform === void 0 ? (_reportPossibleCrUseOfGravityPlatform({
                error: Error()
              }), GravityPlatform) : GravityPlatform).instance.initGeSdk(this.openId); // let ge = new GravityPlatform();
              // ge.initGeSdk(this.openId);
              // window.ge = ge;
            }
          });
        ...
        showShareMenu() {
          var shareUrls = "https://zhishanggoubudao-1328679667.cos.ap-shanghai.myqcloud.com/share/0.webp"; // 替换为实际分享图片URL
          ...
          wx.showShareMenu({
            ...
            success() {
              console.log("showShareMenu 调用成功00");
            },
...
//# sourceMappingURL=bd267bf388a0db28206c2ea69d239a59a2a349dc.js.map