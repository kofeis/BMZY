  ...
  return {
    ...
    execute: function () {
      ...
      _export("Tool_Animation", Tool_Animation = (_dec = ccclass('Tool_Animation'), _dec(_class = (_class2 = class Tool_Animation extends Component {
        ...
        TimReset(Obj_Timing, Clock, Call) {
          if (Clock === void 0) {
            Clock = 60;
          }
        ...
        TimPause(Obj_Timing, Clock, Call) {
          if (Clock === void 0) {
            Clock = 60;
          }
        ...
        TimResume(Obj_Timing, Clock, Call) {
          if (Clock === void 0) {
            Clock = 60;
          }
        ...
        */
        ...
        Get_Min_Distance_Node(Position_World, Target_Parent_Node) {
          ...
          var Children = Target_Parent_Node.children;
          ...
          var Min_Index = 0;
          var Min_Distance = Number.MAX_VALUE; // 遍历子节点，找到距离最小的节点

          for (var i = 0; i < Children.length; i++) {
            var Child_Position = Children[i].worldPosition;
            var Distance = this.Get_Distance(Position_World, Child_Position);
