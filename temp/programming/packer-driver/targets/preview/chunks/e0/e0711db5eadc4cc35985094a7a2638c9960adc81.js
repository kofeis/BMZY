      ...
      _export("default", Script_Scene_Change = (_dec = ccclass('Script_Scene_Change'), _dec2 = property({
        ...
        Scene_Jump_Automatic() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var SceneGame = yield _this2.Resoure_Data.Load_Scene(_this2.Resoure_Data.Scene_Name_Next, _this2.Progress_Mask, _this2.Progress_Bar, _this2.Value, _this2.ScreenMode);
        ...
        Scene_Jump_Manual() {
          ...
          return _asyncToGenerator(function* () {
            if (_this3.Scene_Change_Type == (_crd && Scene_Change_Type === void 0 ? (_reportPossibleCrUseOfScene_Change_Type({
              error: Error()
            }), Scene_Change_Type) : Scene_Change_Type).Finish) {
              _this3.Resoure_Data.Game_End();
            } else if (_this3.Scene_Change_Type == (_crd && Scene_Change_Type === void 0 ? (_reportPossibleCrUseOfScene_Change_Type({
              error: Error()
            }), Scene_Change_Type) : Scene_Change_Type).Manual) {
              _this3.Resoure_Data.Scene_Name_Next = _this3.Path;
              var SceneGame = yield _this3.Resoure_Data.Load_Scene(_this3.Resoure_Data.Scene_Name_Next);

              _this3.Resoure_Data.Director_Run(SceneGame);
...
//# sourceMappingURL=e0711db5eadc4cc35985094a7a2638c9960adc81.js.map