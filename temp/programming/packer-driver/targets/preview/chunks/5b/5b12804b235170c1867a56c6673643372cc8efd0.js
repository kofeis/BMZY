System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, find, isValid, sys, UITransform, v3, view, Widget, instantiate, Sprite, color, UIOpacity, _dec, _class, _class2, _crd, ccclass, property, Tool_UI;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Constructor', 'find', 'isValid', 'Node', 'sys', 'UITransform', 'v3', 'Vec3', 'view', 'Widget', 'Prefab', 'instantiate', 'Sprite', 'SpriteFrame', 'Color', 'color', 'UIOpacity', 'Layers']);
      ...
      _export("Tool_UI", Tool_UI = (_dec = ccclass('Tool_UI'), _dec(_class = (_class2 = class Tool_UI extends Component {
        ...
        */
        ...
        Set_Color(Node_Set, Sprite_Color) {
...
//# sourceMappingURL=5b12804b235170c1867a56c6673643372cc8efd0.js.map