    ...
    execute: function () {
      ...
      _export("Tool_Event", Tool_Event = (_dec = ccclass('Tool_Event'), _dec(_class2 = (_class3 = class Tool_Event extends Component {
        ...
        */
        ...
        On_Event_TOUCH_Drag(Node_Set, Interactable, TOUCH_START_Call, TOUCH_MOVE_Call, TOUCH_END_Call) {
          if (Interactable === void 0) {
            Interactable = () => true;
          }

          if (TOUCH_START_Call === void 0) {
            TOUCH_START_Call = () => {};
          }

          if (TOUCH_MOVE_Call === void 0) {
            TOUCH_MOVE_Call = () => {};
          }

          if (TOUCH_END_Call === void 0) {
            TOUCH_END_Call = () => {};
          }
