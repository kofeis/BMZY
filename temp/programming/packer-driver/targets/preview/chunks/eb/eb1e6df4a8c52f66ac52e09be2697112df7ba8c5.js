  ...
  return {
    ...
    execute: function () {
      ...
      _export("Tool_RigidBody", Tool_RigidBody = (_dec = ccclass('Tool_RigidBody'), _dec(_class = (_class2 = class Tool_RigidBody extends Component {
        /**设置线性速度 */
        Set_Linear_Velocity(Node_Set, X, Y) {
          if (X === void 0) {
            X = 0;
          }
          ...
          var Component_RigidBody = Node_Set.getComponent(RigidBody2D);
        ...
        Set_Linear_Velocity_X(Node_Set, X) {
          if (X === void 0) {
            X = 0;
          }
        ...
        Set_Linear_Velocity_Y(Node_Set, Y) {
          if (Y === void 0) {
            Y = 0;
          }
        ...
        */
        ...
        Collider_Recover(Node_Set, Gravity_Scale) {
          if (Gravity_Scale === void 0) {
            Gravity_Scale = 1;
          }
...
//# sourceMappingURL=eb1e6df4a8c52f66ac52e09be2697112df7ba8c5.js.map