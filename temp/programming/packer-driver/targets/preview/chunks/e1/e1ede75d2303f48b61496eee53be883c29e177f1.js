    ...
    execute: function () {
      ...
      _export("PanelIdiom", PanelIdiom = (_dec = ccclass('PanelIdiom'), _dec(_class = class PanelIdiom extends (_crd && PanelTemplate === void 0 ? (_reportPossibleCrUseOfPanelTemplate({
        ...
        InitData() {
          ...
          return _asyncToGenerator(function* () {
            yield _this7.GetData();
            _this7.ValueStr = "";
            _this7.ValueIndex = 0;
            _this7.ValueMoveing = false;
          })();
        }
        /**获取数据 */
        ...
        GetData() {
          ...
          return _asyncToGenerator(function* () {
            var Json = yield _this8.Resoure_Data.Load_Json("Json/dioms");
            var JsonData = Json["Data"];

            if (_this8.Game_Script.IdiomLevel >= JsonData.length) {
              _this8.KeyData = JsonData[JsonData.length - 1];
            } else {
              _this8.KeyData = JsonData[_this8.Game_Script.IdiomLevel];
            }
          })();
        }
        /**获取结果 */
