      ...
      _export("PanelDish", PanelDish = (_dec = ccclass('PanelDish'), _dec(_class = class PanelDish extends (_crd && PanelTemplate === void 0 ? (_reportPossibleCrUseOfPanelTemplate({
          ...
          return _asyncToGenerator(function* () {
            ...
            var FunPGOptionA = () => {
              ...
              if (_this4.LabelOptionA.string == _this4.Game_Script.TopicData[_this4.Game_Script.TopicIndex].CorrectName) {
                ...
                (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                  error: Error()
                }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(_this4.OptionA, color(0, 255, 0, 255));
              } else {
                _this4.GameFailed();

                (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                  error: Error()
                }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(_this4.OptionA, color(255, 0, 0, 255));
              }
            };
            /**选项B按钮  */
            ...
            var FunPGOptionB = () => {
              ...
              if (_this4.LabelOptionB.string == _this4.Game_Script.TopicData[_this4.Game_Script.TopicIndex].CorrectName) {
                ...
                (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                  error: Error()
                }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(_this4.OptionB, color(0, 255, 0, 255));
              } else {
                _this4.GameFailed();

                (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                  error: Error()
                }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(_this4.OptionB, color(255, 0, 0, 255));
              }
            };
            /**选项C按钮  */
            ...
            var FunPGOptionC = () => {
              ...
              if (_this4.LabelOptionC.string == _this4.Game_Script.TopicData[_this4.Game_Script.TopicIndex].CorrectName) {
                ...
                (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                  error: Error()
                }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(_this4.OptionC, color(0, 255, 0, 255));
              } else {
                _this4.GameFailed();

                (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                  error: Error()
                }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(_this4.OptionC, color(255, 0, 0, 255));
              }
            };
            /**提示按钮 */
        ...
        GameStart() {
          ...
          return _asyncToGenerator(function* () {
            ...
            (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
              error: Error()
            }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(_this5.OptionA);
            (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
              error: Error()
            }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(_this5.OptionB);
            (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
              error: Error()
            }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(_this5.OptionC);
...
//# sourceMappingURL=0a7ed62d25311074613d719e2b533922e6f60dc4.js.map