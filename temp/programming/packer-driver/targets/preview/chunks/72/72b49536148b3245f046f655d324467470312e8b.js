System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, EventHandler, Tool_Event, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _dec3, _dec4, _class4, _class5, _descriptor3, _crd, ccclass, property, Click_Events, Btn_Script;
    ...
    execute: function () {
      ...
      _export("Btn_Script", Btn_Script = (_dec3 = ccclass('Btn_Script'), _dec4 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "Click_Events", _descriptor3, this);
        }
        ...
        start() {
          ...
          for (var i = 0; i < this.Click_Events.Event_Handler.length; i++) {
            var Event = this.Click_Events.Event_Handler[i];
            var Target_Node = Event.target;
            var Scr_Name = Event._componentName;
            var Fun_Name = Event.handler;
            var Custom_EventData = Event.customEventData;
      ...
      }, (_descriptor3 = _applyDecoratedDescriptor(_class5.prototype, "Click_Events", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=72b49536148b3245f046f655d324467470312e8b.js.map