      ...
      _export("PanelMathMatch", PanelMathMatch = (_dec = ccclass('PanelMathMatch'), _dec(_class = class PanelMathMatch extends (_crd && PanelTemplate === void 0 ? (_reportPossibleCrUseOfPanelTemplate({
            ...
            (_crd && Tool_Event === void 0 ? (_reportPossibleCrUseOfTool_Event({
              ...
              (_crd && PlatformApi === void 0 ? (_reportPossibleCrUseOfPlatformApi({
                ...
                _this4.Game_Script.Timer(ComponentLabel, _this4.GameTime, () => {
                  ...
                  _this4.Resoure_Data.Sound_Play("Audio/FH");

                  _this4.Game_Script.TimerStop();

                  find("JG", _this4.node).active = false;
                }, "S", () => {
                  _this4.GameTimeIng++;
                  _this4.GameTime--;

                  if (_this4.GameTime <= _this4.JGTime && !find("JG", _this4.node).active) {
                    find("JG", _this4.node).active = true;
                    find("JG", _this4.node).getComponent(Animation).play();
                  }
                });
              }, () => {
                _this4.Resoure_Data.Music_Resume();
        ...
        InitData() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this5.TipNode = null;
            _this5.GameTimeIng = 0; // this.Game_Script.MathMatchLevel = 6;
            ...
            var JsonData = Json["Data"]; //console.log(JsonData);
            ...
            if (_this5.Game_Script.MathMatchLevel >= JsonData.length) {
              // this.Game_Script.OnMessage("没有更多关卡了");
              var Ran = (_crd && Tool_Other === void 0 ? (_reportPossibleCrUseOfTool_Other({
                error: Error()
              }), Tool_Other) : Tool_Other).instance.Get_Random_Int(20, 35);

              if (Ran < JsonData.length - 1) {
                _this5.GameData = _this5.Resoure_Data.Copy_Deep(JsonData[Ran]);
              } else {
            ...
            _this5.Game_Script.Timer(ComponentLabel, _this5.GameTimeAll, () => {
              ...
              _this5.Resoure_Data.Sound_Play("Audio/FH");

              _this5.Game_Script.TimerStop();

              find("JG", _this5.node).active = false;
            }, "S", () => {
              _this5.GameTimeIng++;
              _this5.GameTime--;

              if (_this5.GameTime <= _this5.JGTime && !find("JG", _this5.node).active) {
                find("JG", _this5.node).active = true;
                find("JG", _this5.node).getComponent(Animation).play();
              }
            });
          })();
        }
                ...
                (_crd && Tool_Event === void 0 ? (_reportPossibleCrUseOfTool_Event({
                  ...
                  if (Obj.Distance <= _this6.OnDistance) {
                    ...
                    if (_this6.LastKeyIndex[_i4] != null && _this6.LastKeyIndex[_i4] != Obj.Index) {
                      ...
                      _this6.KeyExitValue[_this6.LastKeyIndex[_i4]] = null; //console.error(this.KeyExitState[this.LastKeyIndex[i]], "2---------------------", Obj.Index);
                    } //改变Key背景颜色
        ...
        FindAllEquationIndices_(Key, Time, Rows, Cols) {
          ...
          return _asyncToGenerator(function* () {
              ...
              if (Key[i] == "=") {
                ...
                if (i % Rows != Rows - 1 && Math.floor(i / Rows) != Cols - 1) {
                  ...
                  if (ValueResult != null && !Number.isNaN(ValueResult)) {
                    ...
                    var _IsEqual2 = _KeyResult2 == ValueResult; //console.log(Indexs);
                    //console.log(Chars);
                    //console.log("ValueResult", ValueResult, "KeyResult", KeyResult);
                    //console.log("是否相等", IsEqual);
            ...
            var ValueP = find("Value", _this12.node);
...
//# sourceMappingURL=c2d212f3f9079eb2d139a1c3d1579dd6111ae2df.js.map