  ...
  return {
    ...
    execute: function () {
      ...
      _export("PanelTemplate", PanelTemplate = (_dec = ccclass('PanelTemplate'), _dec(_class = class PanelTemplate extends Component {
        ...
        async onLoad() {
          this.Game_Script = find("Canvas/InterfaceGame").getComponent(_crd && Game_Script === void 0 ? (_reportPossibleCrUseOfGame_Script({
            error: Error()
...
//# sourceMappingURL=b2ea2dd47a155d728670fb2cccdc62a1feada2dc.js.map