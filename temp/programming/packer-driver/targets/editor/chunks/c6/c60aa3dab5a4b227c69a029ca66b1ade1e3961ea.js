      ...
      _export("Tool_UI", Tool_UI = (_dec = ccclass('Tool_UI'), _dec(_class = (_class2 = class Tool_UI extends Component {
        ...
        */
        ...
        Get_Touch_Position(Event) {
          ...
          const HalfScreenHeight = this.Get_Height_Design() / 2; // 工具函数：计算触摸位置相对于屏幕中心的位置
        ...
        Set_Color_Sprite(Node_Set, Sprite_Color = color(255, 255, 255, 255)) {
          let Component_Sprite = this.Component_Get(Node_Set, Sprite);
          Component_Sprite.color = Sprite_Color;
        }

        Set_Color_Label(Node_Set, Sprite_Color = color(255, 255, 255, 255)) {
        ...
        Set_UIOpacity(Node_Set, Opacity = 255) {
        ...
        Get_Target_Node_Local_Pos(Node_Set, Target_Node) {
          ...
          const Target_World_Pos = Target_Node.worldPosition; // 将世界坐标转换为 Node_Set 的局部坐标
        ...
        Get_Pos_Is_Equal(Pos, Pos_Target, precision = 0.0001) {
        ...
        FloatIs_Equal(A, B, Precision = 0.0001) {
        ...
        Node_Index_Swap(Node_1, Node_2) {
          ...
          const Index_2 = Node_2.getSiblingIndex(); // 索引相同，无需交换
        ...
        Set_Prefab_Node(Prefab, Parent_Node, Position, Name, Call = () => {}) {
          const Node_Prefab = instantiate(Prefab);
