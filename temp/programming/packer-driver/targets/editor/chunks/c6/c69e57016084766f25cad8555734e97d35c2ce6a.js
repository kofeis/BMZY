    ...
    execute: function () {
      ...
      _export("Login", Login = (_dec = ccclass('Login'), _dec(_class = class Login extends (_crd && Resoure_Data_Template === void 0 ? (_reportPossibleCrUseOfResoure_Data_Template({
        ...
        async Btn_Visitors() {
          ...
          await (_crd && Tool_NetWork === void 0 ? (_reportPossibleCrUseOfTool_NetWork({
            error: Error()
          ...
          let a = await (_crd && Tool_NetWork === void 0 ? (_reportPossibleCrUseOfTool_NetWork({
            error: Error()
        ...
        async Btn_Login() {
          let Account = (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
            error: Error()
          }), Tool_UI) : Tool_UI).instance.Component_Get(find("Canvas/Layer/Window/Account"), EditBox).string;
          let Password = (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
            error: Error()
          }), Tool_UI) : Tool_UI).instance.Component_Get(find("Canvas/Layer/Window/Password"), EditBox).string;
          let Save = this.Resoure_Data.Save_Get();
          Save.Account = Account;
          Save.Password = Password;
          this.Resoure_Data.Save_Set(); // Tool_NetWork.instance.Request_Delete(Tool_NetWork.instance.UrlRequest+"/1");
...
//# sourceMappingURL=c69e57016084766f25cad8555734e97d35c2ce6a.js.map