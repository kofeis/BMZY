System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      HttpRequest = _unresolved_7.HttpRequest;
    }, function (_unresolved_8) {
      GravityPlatform = _unresolved_8.GravityPlatform;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("Game_Script", Game_Script = (_dec = ccclass('Game_Script'), _dec2 = property({
        ...
        async onLoad() {
          ...
          this.PanelMathMatch.active = false; // await this.Resoure_Data.Load_SpriteFrame("SpriteFrame/Panel/PanelMathMatch/BoxC")
        ...
        async start() {
          super.start(); // this.BlockInputEvents.active = true;

          this.OnEvent();
          this.BlockInputEvents.active = false;
          console.log("播放音乐");
          this.Resoure_Data.Music_Play("Audio/BgmGame"); // console.log(HttpRequest.instance.getOpenId());
        ...
        OnPanelSidebar() {
          ...
          const PSI_BtnGetEndCall = () => {// this.Resoure_Data.Sound_Play("Audio/BtnClick");
            // if (this.Resoure_Data.Vibration_Switch_Get()) {
        ...
        IsSharePlayer() {
          if (sys.platform === sys.Platform.WECHAT_GAME || sys.platform === sys.Platform.WECHAT_MINI_PROGRAM) {
            ...
            //     }
            // } 
            let LaunchOptionsSync = (_crd && PlatformApi === void 0 ? (_reportPossibleCrUseOfPlatformApi({
              error: Error()
...
//# sourceMappingURL=d0661d2b6029391d6066a1243ce349f4e07503ad.js.map