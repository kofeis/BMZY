  ...
  return {
    ...
    execute: function () {
      ...
      _export("Tool_Animation", Tool_Animation = (_dec = ccclass('Tool_Animation'), _dec(_class = (_class2 = class Tool_Animation extends Component {
        ...
        Timing(Obj_Timing, Clock = 60, Call = () => {}) {
          Obj_Timing.num = 0;
        ...
        TimReset(Obj_Timing, Clock = 60, Call = () => {}) {
          console.debug("倒计时重置");
        ...
        TimPause(Obj_Timing, Clock = 60, Call = () => {}) {
          console.debug("倒计时暂停");
        ...
        TimResume(Obj_Timing, Clock = 60, Call = () => {}) {
          console.debug("倒计时暂停");
        ...
        TimStop(Obj_Timing, Clock = 60, Call = () => {}) {
          console.debug("倒计时停止");
          this.Tween_Stop_Target(Obj_Timing);
        }
        /**暂停缓动对象 */
        ...
        */
        ...
        Animation_Node_Move_Time(Node_Set, Position, Time = 1, Call = () => {}, Easing = "linear") {
          if (Time < 0) {
            return;
          }
        ...
        */
        ...
        Get_Min_Distance_Node(Position_World, Target_Parent_Node) {
          // 参数校验
          if (!(_crd && Tool_Other === void 0 ? (_reportPossibleCrUseOfTool_Other({
            error: Error()
          }), Tool_Other) : Tool_Other).instance.Get_Type_Is_Abnormal(Position_World) || !(_crd && Tool_Other === void 0 ? (_reportPossibleCrUseOfTool_Other({
            error: Error()
          }), Tool_Other) : Tool_Other).instance.Get_Type_Is_Abnormal(Target_Parent_Node)) {
            console.warn("类型异常");
            return null;
          } // 检查子节点数量
          ...
          let Min_Index = 0;
          let Min_Distance = Number.MAX_VALUE; // 遍历子节点，找到距离最小的节点
...
//# sourceMappingURL=8828dd9c8892aa4917a1fe8732a61e96c6644643.js.map