      ...
      _export("PanelMathMatch", PanelMathMatch = (_dec = ccclass('PanelMathMatch'), _dec(_class = class PanelMathMatch extends (_crd && PanelTemplate === void 0 ? (_reportPossibleCrUseOfPanelTemplate({
        ...
        async OnBtn(AnimSwitch = false) {
          ...
          (_crd && Tool_Event === void 0 ? (_reportPossibleCrUseOfTool_Event({
            error: Error()
          }), Tool_Event) : Tool_Event).instance.On_Event_TOUCH_END(this.Game_Script.PanelSetting.getChildByName("BtnLayout").getChildByName("BtnContinue"), BtnContinue);
          /**设置按钮 */
          ...
          (_crd && Tool_Event === void 0 ? (_reportPossibleCrUseOfTool_Event({
            error: Error()
          }), Tool_Event) : Tool_Event).instance.On_Event_TOUCH_END(this.PanelFail.getChildByName("BtnNext"), () => {
            this.GameStart();
          });
          (_crd && Tool_Event === void 0 ? (_reportPossibleCrUseOfTool_Event({
            error: Error()
        ...
        async InitData() {
          ...
          this.TipLabel = null;
          this.TipNode = null;
          this.GameTimeIng = 0; // this.Game_Script.MathMatchLevel = 7;
          ...
          if (this.Game_Script.MathMatchLevel >= JsonData.length) {
            ...
            this.Game_Script.MathMatchLevel = JsonData.length; // let Ran = Tool_Other.instance.Get_Random_Int(20, 35);
          ...
          console.log(this.GameData.Result); //console.log(this.GameData);
        ...
        async FindAllEquationIndices_(Key, Time = 0, Rows = 11, Cols = 11) {
            ...
            if (Key[i] == "=") {
              ...
              if (i % Rows != Rows - 1 && Math.floor(i / Rows) != Cols - 1) {
                ...
                if (ValueResult != null && !Number.isNaN(ValueResult)) {
                  ...
                  console.log(Chars);
                  let KeyResult = GetResult(Chars);
                  let IsEqual = KeyResult == ValueResult; // console.log("主对角线");
                  // console.log(Indexs);
                  // console.log("ValueResult", ValueResult, "KeyResult", KeyResult);
                  // console.log("是否相等", IsEqual);
          ...
          let ValueP = find("Value", this.node); // console.error(Result.CorrectIndex);
...
//# sourceMappingURL=abbea6c0b11fc5c1fe60e3a5f51bb9cb3d504e94.js.map