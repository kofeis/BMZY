  ...
  return {
    ...
    execute: function () {
      ...
      _export("HttpRequest", HttpRequest = (_dec = ccclass('HttpRequest'), _dec(_class = (_class2 = class HttpRequest extends Component {
          ...
          if (window.wx) {
            ...
            wx.login({
              success: res => {
                ...
                this.request("zdydc/user/login", // 登录接口路径
                params, response => {
                  if (response.openId) {
        ...
        request(endpoint, data, successCallback, errorCallback, isAbsoluteUrl = false, method = "POST") {
          // 构造完整URL
          ...
          const xhr = new XMLHttpRequest(); // 状态变更回调
...
//# sourceMappingURL=cf4c0f805bde97dcb4e6e819eef4678c34cb753c.js.map