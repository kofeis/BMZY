    ...
    execute: function () {
      ...
      _export("PanelDish", PanelDish = (_dec = ccclass('PanelDish'), _dec(_class = class PanelDish extends (_crd && PanelTemplate === void 0 ? (_reportPossibleCrUseOfPanelTemplate({
        ...
        async OnBtn(AnimSwitch = false) {
          ...
          const FunPGOptionA = () => {
            ...
            if (this.LabelOptionA.string == this.Game_Script.TopicData[this.Game_Script.TopicIndex].CorrectName) {
              ...
              (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                error: Error()
              }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(this.OptionA, color(0, 255, 0, 255));
            } else {
              this.GameFailed();
              (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                error: Error()
              }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(this.OptionA, color(255, 0, 0, 255));
            }
          };
          /**选项B按钮  */
          ...
          const FunPGOptionB = () => {
            ...
            if (this.LabelOptionB.string == this.Game_Script.TopicData[this.Game_Script.TopicIndex].CorrectName) {
              ...
              (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                error: Error()
              }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(this.OptionB, color(0, 255, 0, 255));
            } else {
              this.GameFailed();
              (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                error: Error()
              }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(this.OptionB, color(255, 0, 0, 255));
            }
          };
          /**选项C按钮  */
          ...
          const FunPGOptionC = () => {
            ...
            if (this.LabelOptionC.string == this.Game_Script.TopicData[this.Game_Script.TopicIndex].CorrectName) {
              ...
              (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                error: Error()
              }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(this.OptionC, color(0, 255, 0, 255));
            } else {
              this.GameFailed();
              (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
                error: Error()
              }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(this.OptionC, color(255, 0, 0, 255));
            }
          };
          /**提示按钮 */
        ...
        async GameStart() {
          ...
          (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
            error: Error()
          }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(this.OptionA);
          (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
            error: Error()
          }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(this.OptionB);
          (_crd && Tool_UI === void 0 ? (_reportPossibleCrUseOfTool_UI({
            error: Error()
          }), Tool_UI) : Tool_UI).instance.Set_Color_Sprite(this.OptionC);
          this.UpdatePropUI();
          /**更新提示 */
