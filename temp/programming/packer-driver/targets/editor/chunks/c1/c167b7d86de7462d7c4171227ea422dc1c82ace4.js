    ...
    execute: function () {
      ...
      _export("Game_Script_Template", Game_Script_Template = (_dec = ccclass('Game_Script_Template'), _dec(_class = class Game_Script_Template extends Component {
        ...
        DataGet() {
          ...
          /**openId */
          let openId = this.Resoure_Data.Data_Get("openId");
          ...
          let ShareRewardCount = this.Resoure_Data.Data_Get("ShareRewardCount");
          ...
          let InvitedCount = this.Resoure_Data.Data_Get("InvitedCount");
          ...
          let ShareTime = this.Resoure_Data.Data_Get("ShareTime");
          ...
          let SidebarSwitch = this.Resoure_Data.Data_Get("SidebarSwitch");
          ...
          let SidebarState = this.Resoure_Data.Data_Get("SidebarState");
          ...
          let PlaceBarId = this.Resoure_Data.Data_Get("PlaceBarId");
          ...
          let HighestRecord = this.Resoure_Data.Data_Get("HighestRecord");
          ...
          let DishScoreEndless = this.Resoure_Data.Data_Get("DishScoreEndless");
          ...
          let LastPlayId = this.Resoure_Data.Data_Get("LastPlayId");
          ...
          let ConfigRegionDish = this.Resoure_Data.Data_Get("ConfigRegionDish");
          ...
          let ConfigRegionRanking = this.Resoure_Data.Data_Get("ConfigRegionRanking");
          ...
          let IdiomLevel = this.Resoure_Data.Data_Get("IdiomLevel");
          ...
          let IdiomScore = this.Resoure_Data.Data_Get("IdiomScore");
          ...
          let FilmLevel = this.Resoure_Data.Data_Get("FilmLevel");
          ...
          let FilmScore = this.Resoure_Data.Data_Get("FilmScore");
          ...
          let FindActorLevel = this.Resoure_Data.Data_Get("FindActorLevel");
          ...
          let FindActorScore = this.Resoure_Data.Data_Get("FindActorScore");
        ...
        GetDishData() {
          //总菜品
          let DishDataAll = this.Resoure_Data.Data_Get("DishDataAll");
          ...
          if (this.DishDataAll == null) {
            ...
            this.ConfigRegionDish.forEach(Key => {
              ...
              const KeyId = `DishId${Key.NamePinYin}`;
              const KeyData = `DishData${Key.NamePinYin}`;
              const KeyDataV = `DishData${Key.NamePinYin}Victory`;
              this[KeyData] = [];
              this[KeyDataV] = [];
              let Index = 1;
        ...
        GetTopicData() {
          ...
          const KeyData = `DishData${this.ConfigRegionDish[KeyId].NamePinYin}`;
        ...
        CheckIdiomProgress(Char) {
          // 拼接新字符形成候选字符串
          const Candidate = this.IdiomCurrent + Char; // 检查是否是完整成语

          const isComplete = this.IdiomData.indexOf(Candidate); // 检查是否有成语以这个候选字符串开头

          const isValid = this.IdiomData.some(Idiom => Idiom.startsWith(Candidate));
