import { _decorator, Button, CCObject, Collider2D, color, Color, Component, Contact2DType, EventTouch, Graphics, input, Input, macro, Node, NodeEventType, PolygonCollider2D, RigidBody2D, Tween, tween, UIOpacity, UITransform, v2, v3, Vec2, Vec3, view, Animation } from 'cc';
